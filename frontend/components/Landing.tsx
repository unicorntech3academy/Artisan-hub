          ...
          <div className="flex items-center gap-4">
            {currentUser ? (
              <button 
                ...
                className="bg-emerald-600 text-white px-6 py-3 rounded-2xl text-sm font-extrabold hover:bg-emerald-700 transition-all shadow-xl shadow-emerald-100 flex items-center gap-2"
              >
                Go to Dashboard
              ...
              <>
                ...
                <button 
                  onClick={() => setActiveView('auth')}
                  className="bg-emerald-600 text-white px-6 py-3 rounded-2xl text-sm font-extrabold hover:bg-emerald-700 transition-all shadow-xl shadow-emerald-100"
                >
                  Get Started
                </button>
              </>
