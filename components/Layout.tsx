            ...
            <div className="flex items-center gap-6">
              {currentUser ? (
                ...
                <div className="flex gap-4">
                  <button className="text-sm font-black text-gray-600 hover:text-emerald-600 transition-colors">Login</button>
                  <button className="bg-emerald-600 text-white px-6 py-2.5 rounded-xl text-sm font-black hover:bg-emerald-700 transition-all shadow-lg shadow-emerald-100">
                    Sign Up
                  </button>
                </div>
              )}
